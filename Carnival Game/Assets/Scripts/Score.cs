...
public class Score : MonoBehaviour
{
    ...
    {
        timerText.text = "Time: " + GetComponent<Timer>().timer.ToString(); // Sets the timer variable from Timer script to the timerText TextMeshProUGUI component referenced earlier
